...
public class BasicModeMain{
    ...
    /**
     * Get the title for the selected mode
     * 
    ...
    private String getModeTitle() {
        if(modeGUI == 0) {
        	...
        	if(typeGame == 0) {
        		...
        		return "Tien len mien nam - " + mode;
        	}
        	else if(typeGame == 2) {
        		return "Tien len mien bac - " + mode;
        	}
        }
        
        String mode = "Graphical mode";
        if(typeGame == 0) {
        	return "Ba cay - " + mode;
        }
        else if(typeGame == 1) {
